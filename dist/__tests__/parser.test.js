...
describe("BringParser", () => {
    describe("Basic parsing", () => {
        ...
        empty = null
      `;
            const result = (0, index_1.parse)(config);
            const obj = (0, index_1.toObject)(result);
      ...
      `;
            ...
            const schema = result["schema:User"];
    ...
    describe("Error handling", () => {
        test("throws error for invalid syntax", () => {
            expect(() => {
                (0, index_1.parse)("invalid = @#$");
            }).toThrow(index_1.BringParseError);
        });
        test("throws error for unterminated string", () => {
            expect(() => {
                (0, index_1.parse)('name = "unterminated');
            }).toThrow(index_1.BringParseError);
        });
        test("throws error for missing closing brace", () => {
            expect(() => {
                (0, index_1.parse)('obj = { key = "value"');
            }).toThrow(index_1.BringParseError);
        });
        test("provides error position information", () => {
            try {
                ...
                expect(error).toBeInstanceOf(index_1.BringParseError);
    ...
    describe("Utility functions", () => {
        ...
        test("toJSON converts correctly", () => {
            ...
            const result = (0, index_1.parse)(config);
            const json = (0, index_1.toJSON)(result);
